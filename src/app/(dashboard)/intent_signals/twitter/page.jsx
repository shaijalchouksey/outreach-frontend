...
import IntentHeader from "@/components/ui/header/TwitterHeader";
import Sidebar from "@/components/ui/sidebar/Sidebar";
import SearchBar from "@/components/ui/search_bar/SearchBar";
import TwitterFilterPanel from "@/components/ui/filters/TwitterFilterPanel";
...
const Page = () => {
  ...
  const statsCards = [
    { title: "Tweets Detected", value: "245", trend: 12, trendText: "+12% from last week" },
    { title: "Avg Engagement Rate", value: "4.8%", trend: 2.0, trendText: "+2.0% from last week" },
    { title: "Top Source Type", value: "Original Tweets (42%)", trend: 1.0, trendText: "+1.0% from last week" },
    { title: "Most Active Category", value: "Pharma & Biotech", trend: 0.5, trendText: "+0.5% from last week" },
  ];
  ...
  const interactionData = [
    ...
    { label: "Trending Tweets", value: 8 },
  ];

  const topSourcesData = [
    { name: "Tweets", value: 42, color: "#7C3AED" },
    { name: "Retweets", value: 35, color: "#A78BFA" },
    { name: "Replies", value: 23, color: "#C4B5FD" },
  ];

  const topPerformingPosts = [
    { handle: "Zenotech expands R&D unit with new...", description: "Source: Tweet", views: "20k Views" },
    { handle: "ZENOTECH shows strong Q3 growth...", description: "Source: Tweet", views: "15k Views" },
  ];
  ...
  const tableData = [
    {
      "tweet(url)": "Zenotech's R&D expansion to fuel innovation",
      sourcetype: "Tweet",
      keyword: "#Zenotech",
    ...
    {
      "tweet(url)": "ZENOTECH trending on investor forums",
      sourcetype: "Tweet",
      keyword: "#StockMarket",
    ...
    {
      "tweet(url)": "Regulatory delays but strong pipeline ahead",
      sourcetype: "Reply",
      keyword: "#Pharma",
    ...
    <div className="h-screen bg-gray-50 flex overflow-hidden">
      ...
      <div className="flex-1 flex flex-col overflow-hidden relative">
        ...
        <div className="flex-1 flex overflow-hidden relative">
            ...
            <div className="grid grid-cols-1 xl:grid-cols-3 gap-4 mb-6 items-stretch">
              <div className="xl:col-span-2 bg-white rounded-2xl p-6 border border-gray-200 shadow-sm flex flex-col">
                <SignalDistributionChart
                  ...
                  highlight={{
                    text: "Likes and retweets continue to dominate engagement, while trending tweets and keyword spikes show rising interest.",
                    subText: "",
                  }}
                  color="purple"
                />
          ...
          >
            <TwitterFilterPanel onClose={handleFilterClose} onApply={handleFilterApply} />
          </div>
        </div>
      </div>
    </div>
