...
export default function InstagramFilterPanel({ onClose, onApply }) {
  ...
  return (
    <div
      className="w-full sm:w-96 max-w-[min(90vw,24rem)] bg-white shadow-lg border-l border-gray-200 flex flex-col h-full
                 ...
                 [&_input[type='checkbox']]:border-gray-300 [&_input[type='checkbox']]:checked:bg-pink-500 
                 [&_input[type='checkbox']]:checked:border-transparent [&_input[type='checkbox']]:focus:ring-pink-400"
    >
      {/* Header */}
        ...
        <div>
          ...
          {!isCollapsed("Page Type") && (
            <div className="space-y-2">
              {["Person", "Company", "Business"].map((type) => (
            ...
            <>
              <div className="relative">
                <input
                  ...
                  className="w-full pl-4 pr-12 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-pink-400 text-sm"
                />
                <button
                  onClick={handleAddKeyword}
                  className="absolute right-3 top-1/2 -translate-y-1/2 text-pink-500 text-sm font-medium"
                >
                  Add
                </button>
              </div>
      ...
      <div className="p-4 border-t border-gray-200 bg-white">
        <button
          ...
          className="w-full bg-pink-500 text-white py-2.5 rounded-lg hover:bg-pink-600 font-medium"
        >
          Apply Filters
        </button>
      </div>
