...
export default function ThreadsFilterPanel({ onClose, onApply }) {
  ...
  const [keywords, setKeywords] = useState(["#Zenotech", "#PharmaResearch", "#StockMarket"]);
      ...
      <div className="p-4 sm:p-6 space-y-6 overflow-y-auto flex-1 scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100">
        ...
        <div>
          ...
          {!isCollapsed("Automation Criteria") && (
            <div className="space-y-2">
              {[
                "Check Threads (every 2 hrs)",
                "Include replies & reposts",
                "Minimum Engagement: 50+",
              ].map((opt) => (
