...
export default function YouTubeFilterPanel({ onClose, onApply }) {
  ...
  return (
    <div
      className="w-full sm:w-96 max-w-[min(90vw,24rem)] bg-white shadow-lg border-l border-gray-200 flex flex-col h-full
                 ...
                 [&_input[type='checkbox']]:border-gray-300 [&_input[type='checkbox']]:checked:bg-red-600 
                 [&_input[type='checkbox']]:checked:border-transparent [&_input[type='checkbox']]:focus:ring-red-500"
    >
      {/* Header */}
            ...
            <>
              <div className="relative">
                <input
                  ...
                  className="w-full pl-4 pr-12 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500 text-sm"
                />
                <button
                  onClick={handleAddKeyword}
                  className="absolute right-3 top-1/2 -translate-y-1/2 text-red-600 text-sm font-medium"
                >
                  Add
                </button>
              </div>
