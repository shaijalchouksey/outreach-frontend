...
export default function ReusableHeader({
  ...
  return (
    <header className="bg-white border-b border-gray-200 sticky top-0 z-30 px-3 sm:px-4 md:px-6 py-2 sm:py-3 h-auto sm:h-[65px] flex-shrink-0 w-full rounded-md shadow-sm transition-all">
          ...
          <div className="flex flex-wrap items-center gap-1 sm:gap-2">
            ...
            {page && (
              <>
                ...
                <h2
                  className={`text-xs sm:text-sm md:text-base font-semibold text-${color}-600 whitespace-nowrap`}
                >
                  {page}
                </h2>
              </>
