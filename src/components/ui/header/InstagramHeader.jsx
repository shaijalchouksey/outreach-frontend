...
export default function IntentHeader({
  ...
  const details = PLATFORM_DETAILS[key] || PLATFORM_DETAILS.instagram;
  const Icon = details.icon;

  return (
    <header className="bg-white border-b border-gray-200 px-3 sm:px-4 md:px-6 py-2 sm:py-3 h-auto sm:h-[65px] flex-shrink-0 rounded-md w-full shadow-sm transition-all duration-200">
        ...
        <div className="flex flex-wrap items-center gap-2 sm:gap-3">
          ...
          >
            {isSidebarOpen ? (
              ...
              <ChevronLeft className="w-5 h-5 sm:w-6 sm:h-6 transition-transform duration-200" />
            )}
          </button>
