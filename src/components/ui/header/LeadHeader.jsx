...
export default function LeadHeader({
  ...
  return (
    <header className="bg-white border-b border-gray-200 px-3 sm:px-4 md:px-6 py-2 sm:py-3 h-auto sm:h-[65px] w-full flex-shrink-0 rounded-md shadow-sm">
      <div className="flex flex-wrap items-center justify-between gap-3 sm:gap-4">
        {/* Left Section */}
        <div className="flex flex-wrap items-center gap-2 sm:gap-3">
          {/* Sidebar Toggle (Hamburger ↔ Back) */}
          <button
