...
export default function IntentHeader({
  ...
  const details = PLATFORM_DETAILS[key] || PLATFORM_DETAILS.linkedin;
  ...
  return (
    <header className="bg-white border-b border-gray-200 px-3 sm:px-4 md:px-6 py-2 sm:py-3 h-auto sm:h-[65px] w-full flex-shrink-0 rounded-md shadow-sm transition-all duration-200">
