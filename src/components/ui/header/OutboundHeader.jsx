...
export default function OutboundHeader({
  ...
  return (
    <header className="bg-white border-b border-gray-200 sticky top-0 z-30 px-3 sm:px-4 md:px-6 py-2 sm:py-3 w-full h-auto sm:h-[65px] flex-shrink-0 rounded-md shadow-sm transition-all duration-200">
      <div className="flex flex-wrap items-center justify-between gap-3 sm:gap-4">
        {/* === Left Section === */}
        <div className="flex flex-wrap items-center gap-2 sm:gap-3">
          {/* Sidebar Toggle (Hamburger ↔ Back Icon) */}
          <button
          ...
          {/* Section and Page Breadcrumb */}
          <div className="flex flex-wrap items-center gap-1 sm:gap-2">
            <h2 className="text-xs sm:text-sm md:text-base text-gray-800 font-semibold whitespace-nowrap">
              {section}
            </h2>
            ...
            {page && (
              <>
                ...
                <h2 className="text-xs sm:text-sm md:text-base font-semibold text-purple-600 whitespace-nowrap">
                  {page}
                </h2>
              </>
            )}
          ...
          {/* Last Synced Info */}
          {lastSynced && (
            <span className="text-[10px] sm:text-xs md:text-sm text-gray-500 flex items-center gap-1 sm:gap-2 border border-gray-200 bg-gray-50 px-2 sm:px-3 py-0.5 sm:py-1 rounded-md whitespace-nowrap">
