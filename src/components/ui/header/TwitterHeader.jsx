...
export default function IntentHeader({
  ...
  const details = PLATFORM_DETAILS[key] || PLATFORM_DETAILS.twitter;
  ...
  return (
    <header className="bg-white border-b border-gray-200 sticky top-0 z-30 w-full px-3 sm:px-4 md:px-6 py-2 sm:py-3 rounded-md shadow-sm transition-all duration-200">
