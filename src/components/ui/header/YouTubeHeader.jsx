...
export default function IntentHeader({
  ...
  const details = PLATFORM_DETAILS[key] || PLATFORM_DETAILS.youtube;
  ...
  return (
    <header className="bg-white border-b border-gray-200 sticky top-0 z-30 px-3 sm:px-4 md:px-6 py-2 sm:py-3 h-auto sm:h-[65px] w-full rounded-md shadow-sm transition-all duration-200">
      <div className="flex flex-wrap items-center justify-between gap-3 sm:gap-4">
        {/* ===== Left Section ===== */}
        <div className="flex flex-wrap items-center gap-2 sm:gap-3">
          {/* Sidebar Toggle (Menu ↔ Back) */}
          <button
